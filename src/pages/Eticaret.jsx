...
function Eticaret() {
  ...
  return (
    <>
        ...
        <meta name="description" content="Romsis, e-ticaret sitesi geliştirme, pazaryeri entegrasyonları, SEO ve dijital pazarlama, ödeme ve lojistik çözümleri gibi hizmetler sunuyor. E-ticaret dünyasında büyüme için en iyi çözümleri sunuyoruz." />
        <meta name="keywords" content="e-ticaret, danışmanlık, pazaryeri entegrasyonları, SEO, dijital pazarlama, ödeme çözümleri, lojistik, müşteri deneyimi" />
        <meta property="og:title" content="E-Ticaret ve Danışmanlık Hizmetleri | Romsis" />
        <meta property="og:description" content="Romsis, e-ticaret sitesi geliştirme ve dijital pazarlama çözümleriyle işletmenizi büyütmek için en iyi hizmeti sunuyor." />
...
<img src={eticaret} alt="" className="eticaret-img" />
      ...
      <Row className="text-center mb-4 uibaslik">
        <Col>
          ...
          <p className="lead">
            İşinizi dijital dünyada büyütmek için ihtiyacınız olan her şey bir arada!
          </p>
        </Col>
      </Row>
          ...
          {services.map((service, index) => (
            <Col key={index} md={4} className="mb-4">
              <Card className="border-0">
                <Card.Body>
                  <Card.Title className="text-center uibaslik">{service.title}</Card.Title>
      ...
      <Row className="mb-5">
  <Col>
    <h2 className="text-center mb-4 uibaslik">DANIŞMANLIK HİZMETLERİ</h2>
    <Row className="eticaret-kart border m-5 d-flex justify-content-center align-items-center">
...
<Col>
    ...
    <h3 style={{color:'#142e70'}} >Yenilikçi e-ticaret çözümleri ve profesyonel danışmanlık hizmetlerimiz hakkında teklif almak için bizimle iletişime geçin.</h3>
