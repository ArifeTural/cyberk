...
import digi from "../assets/dijital.jpg"
...
const Digital = () => {
  ...
  return (
    ...
    <Container>
      ...
      <Helmet>
        <title>Dijital Dönüşüm Çözümleri | İşletmenizi Geleceğe Taşıyan Teknolojiler</title>
        <meta name="description" content="Bulut teknolojileri, yapay zeka, büyük veri, siber güvenlik ve daha fazlasıyla işletmenizi dijital dönüşüm sürecine hazırlayın." />
        <meta name="keywords" content="dijital dönüşüm, bulut teknolojileri, yapay zeka, büyük veri, siber güvenlik, iş süreçleri, blok zinciri, AR/VR teknolojileri" />
        <meta property="og:title" content="Dijital Dönüşüm Çözümleri | İşletmenizi Geleceğe Taşıyan Teknolojiler" />
        <meta property="og:description" content="Bulut teknolojileri, yapay zeka, büyük veri, siber güvenlik ve daha fazlasıyla işletmenizi dijital dönüşüm sürecine hazırlayın." />
        <meta property="og:image" content={digi} />
        <meta property="og:url" content="https://www.orneksite.com/dijital-donusum" />
        <meta name="twitter:title" content="Dijital Dönüşüm Çözümleri | İşletmenizi Geleceğe Taşıyan Teknolojiler" />
        <meta name="twitter:description" content="Bulut teknolojileri, yapay zeka, büyük veri, siber güvenlik ve daha fazlasıyla işletmenizi dijital dönüşüm sürecine hazırlayın." />
  ...
  <div className="row mb-5 dijital-gris g-0">
    ...
    <div className=" col-md-12 col-lg-4">
      <div className="card-body">
        <h1 className="card-title digi-baslik">Dijital Dönüşüm Çözümleri: İşletmenizi Geleceğe Taşıyan Teknolojiler</h1>
        <p className="card-text digi-par">
        Bulut teknolojileri, yapay zeka, büyük veri, siber güvenlik ve daha fazlasıyla işletmenizi dijital dönüşüm sürecine hazırlayın. Verimliliği artıran modern çözümlerle rekabette öne geçin.Bu başlık ve açıklama, hem arama motorları için optimize edilmiş hem de kullanıcıların ilgisini çekecek şekilde hazırlanmıştır. Geri bildirimleriniz varsa geliştirebilirim!
        </p>
      </div>
    </div>
  </div>
</div>
  <div><h2 className="text-center fw-bold text-secondary">HİZMETLERİMİZ</h2></div>
...
<Col>
    ...
    <h3 style={{color:'#142e70'}} >Şirketinizin ihtiyaçlarına özel dijital dönüşüm çözümleri için teklif almak ister misiniz?</h3>
