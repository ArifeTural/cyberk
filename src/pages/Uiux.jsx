...
const Uiux = () => {
  ...
  const uiuxsurec = [
    ...
    },
    {
      ...
      title: "Prototipleme",
      description:
        "Fikirlerin hızlı bir şekilde test edilebilmesi için düşük veya yüksek çözünürlüklü prototipler oluşturulur.",
    },
    {
      id: 3,
      title: "Test Etme",
      description:
        "Prototipler, kullanıcıların geri bildirimlerini almak ve geliştirmek için test edilir.",
    },
    {
      id: 4,
      title: "İterasyon",
  ...
  const uiuxteknolojiler = [
    ...
    },
    {
      ...
      title: "Adobe XD",
      description:
        "Adobe XD, prototipleme ve tasarım için güçlü bir platformdur.",
    },
    {
      id: 3,
      ...
      title: "Sketch",
      description:
        "Sketch, UI ve UX tasarımında yaygın olarak kullanılan bir yazılımdır.",
    },
    {
      id: 4,
      ...
      title: "Zeplin",
      description:
        "Tasarımcılar ve geliştiriciler arasında köprü görevi gören bir araç.",
    },
  ];
  ...
  return (
    <Container fluid className="py-4" style={{ backgroundColor: "#f8f9fa" }}>
      <Helmet>
        ...
        <meta
          name="description"
          content="UI ve UX tasarımı, kullanıcı dostu modern web ve mobil uygulama çözümleri sunmak için kritik öneme sahiptir. Figma, Adobe XD, Sketch gibi araçlarla gerçekleştirilir."
        />
        <meta
          name="keywords"
          content="UI tasarımı, UX tasarımı, kullanıcı deneyimi, kullanıcı arayüzü, Figma, Adobe XD, Sketch, Zeplin, prototipleme, web tasarımı"
        />
